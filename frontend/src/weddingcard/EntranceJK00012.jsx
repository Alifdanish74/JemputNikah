...
// components/EntranceJK00012.tsx
...
const EntranceJK00012 = ({ onClose, setIsPlaying }) => {
    ...
    <LoadingWrapper isLoading={loading || (!weddingCard && !error)}>
      {error ? (
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `url(https://jemputkahwin-bucket.s3.ap-southeast-1.amazonaws.com/JK00012/JK00012Background.png)`,
          ...
          <div className="z-10">
            ...
            {!["D"].includes(weddingCard.pihakMajlis) &&
              ["L", "LL"].includes(weddingCard.pihakMajlis) && (
                <>
                  {/* NAMA PENGANTIN */}
                  <div className={`mt-20 mb-20 text-6xl ${weddingCard.jenisFont}`}>
                    <motion.h1
...
export default EntranceJK00012;
